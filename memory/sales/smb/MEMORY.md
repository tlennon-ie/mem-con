---
name: smb-memory-index
description: Memory index for SMB & Self-Serve — pointers to all typed context files
metadata:
  type: index
  area: smb
  team: sales
...
**Status:** Unseeded — run `/populate-context smb` to fill with real content.
